...
<html>
  <head>
    ...
    <title>unconfirmed seller order</title>
  ...
  <body>
	...
	<%
			...
			orderdao.findSOrderlist(Integer.parseInt(userid), orderlist);
			String status ="";
			if(orderlist != null){
 	...
 	%>
 				<tr>
 					...
 					<td><a href='UserServlet?action=orderdetail&orderid=<%=orderlist.get(i).getOrderid()%>'><%=orderlist.get(i).getBuyername()%></a>
