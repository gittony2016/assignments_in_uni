...
<form name="modify" method="post">      
	<table border="1" width="80%">
			<tr><td>ItemType ID</td><td><input type="text" name="listid" value=""><br></td></tr>
			<tr><td>ItemType Name</td><td><input type="text" name="listname" value=""><br></td></tr>	
			<tr>
			<!-- Use the onclick function to separate different methods and do different actions. -->
				<td align="center"><input type="reset" name="reset" value="Reset"></td>
				<td align="center"><input type="submit" name="add" value="Add"  onclick="return action_confirm('add')"></td>
